...
<button type="button" class="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
  ...
  <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Modal title 1</h5>
    ...
    <div class="row">
        <div class="col-3">
            <aside> @yield('contentAside1') </aside>
        </div>
        <div class="col-9">
            <main> @yield('contentMain1')</main>
        </div>
    </div>
<footer> @yield('contentFootaer1')
